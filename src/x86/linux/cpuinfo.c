 ...
 */
static bool parse_line(const char* line_start, const char* line_end, void* vstate, uint64_t line_number) {
	struct proc_cpuinfo_parser_state* state = vstate;	/* Empty line. Skip. */
